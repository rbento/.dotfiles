...
winget install 7zip.7zip Amazon.Kindle DEVCOM.Lua EpicGames.EpicGamesLauncher GNU.Emacs Git.Git GitHub.GitLFS GnuPG.GnuPG Google.Chrome Microsoft.PIX Microsoft.VisualStudio.2022.Community Microsoft.VisualStudioCode Microsoft.WinDbg Oracle.JDK.21 Renderdoc Vim.Vim 
echo : OK
