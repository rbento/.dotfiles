...
winget install 7zip.7zip Amazon.Kindle EpicGames.EpicGamesLauncher GNU.Emacs Git.Git GnuPG.GnuPG Google.Chrome Microsoft.PIX Microsoft.VisualStudio.2022.Community Microsoft.VisualStudioCode Oracle.JDK.21 Renderdoc Vim.Vim 
echo : OK
